...
namespace _1_Game_of_life
{
    public partial class game : Form
    {
        ...
        {
            MessageBox.Show("Правила пользования\n1.Перед началом выберите цвет\n2.Чтобы удалить неугодный квадратик, используйте ластик\n\nОбратите внимание что добавить и убрать квадратик можно только на паузе");
        }
        ...
        private void label_Click(object sender, EventArgs e) //работа с закрашиванием красных или синих клеток на панели
        {
            ...
            {
                lab[x, y].BackColor = System.Drawing.Color.White; // закрасить синим
                lab[x, y].Tag = 0; // смена тэга
            }
